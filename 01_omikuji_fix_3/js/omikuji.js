...
const omikujiText=document.getElementById("omikijiText");
...
btn1.addEventListener("click",
    ...
    function(){
        ...
        let resultsMinSpeed =[1,1,1,1,1];
        let resultMaxSize = [30,30,30,40,30];
        let resultImage = ["img/star.png","img/sakura_hanabira.png","img/love2.png","img/maple.png","img/leaf.png"];
        ...
        omikujiTextImage.src=resultText[n];//おみくじのテキスト画像
